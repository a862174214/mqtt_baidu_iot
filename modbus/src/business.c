...
//const char* const CONFIG_FILE = "/home/root/baidu_iot/gwconfig.txt";
...
static int g_cache_size = 1024 * 1024;    // 1 MB,
...
extern int write_modbus(int slaveid, int startAddress, char* data);
